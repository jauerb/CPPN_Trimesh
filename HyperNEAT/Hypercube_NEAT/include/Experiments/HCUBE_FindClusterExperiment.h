#ifndef HCUBE_FINDCLUSTER_H_INCLUDED
#define HCUBE_FINDCLUSTER_H_INCLUDED
...
namespace HCUBE
{
    class FindClusterExperiment : public Experiment
    {
    public:
    protected:
    ...
    public:
        FindClusterExperiment(string _experimentName);

        virtual ~FindClusterExperiment()
        {}
    ...
    class FindClusterStats : public NEAT::Stringable
    {
    public:
        ...
        {
            return new FindClusterStats(*this);
        }
    };
}

#endif // HCUBE_FINDCLUSTER_H_INCLUDED
