...
namespace HCUBE
{
    BEGIN_EVENT_TABLE(ExperimentPanel, wxPanel)
        ...
        EVT_BUTTON(ID_RerunAllButton, ExperimentPanel::postHocAll)
    END_EVENT_TABLE()
...

    {
        ...
        rerunAllButton = new wxButton(
            this,
            ID_RerunAllButton,
            CSTR_TO_WXSTRING("Rerun All")
            //wxPoint(300,50),
            //wxSize(80,20)
        );
        ...
        mainSizer->Add(rerunAllButton,0,wxALIGN_CENTER|wxALL,10);
    ...
    void ExperimentPanel::postHocAll(wxCommandEvent& WXUNUSED(event))
    {
        cout << "Analyzing all" << endl;
        //((MainFrame*)GetParent())->analyzeIndividual(generationControl->GetValue()-1,individualControl->GetValue()-1);
    }
