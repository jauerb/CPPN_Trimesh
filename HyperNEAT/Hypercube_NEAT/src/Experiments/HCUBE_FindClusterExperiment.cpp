...
namespace HCUBE
{
    ...
    void FindClusterExperiment::generateSubstrate()
    {
        ...
        try
        {
            nodes = (NEAT::NetworkNode*)malloc(sizeof(NEAT::NetworkNode)*numNodesX*numNodesY*2);
            links = (NEAT::NetworkLink*)malloc(sizeof(NEAT::NetworkLink)*numNodesX*numNodesY*numNodesX*numNodesY);
        }
            ...
            for (int x1=0;x1<numNodesX;x1++)
            {
                for (int y2=0;y2<numNodesY;y2++)
                {
                    for (int x2=0;x2<numNodesX;x2++)
                    {
                        try
                        {
                            new (&links[linkCounter]) NetworkLink(&nodes[y1*numNodesX*2 + x1*2 + 0],&nodes[y2*numNodesX*2 + x2*2 + 1],0.0);
    ...
    )
    {
        ...
        */
        ...
        for (int y2=0;y2<numNodesY;y2++)
        {
            for (int x2=0;x2<numNodesX;x2++)
            {
                double value = substrate.getValue(nameLookup[Node(y2,x2,1)]);
        ...
        if (drawContext)
        {
            string fromNodeName = nameLookup[Node(userDisplayOutputLinkWeights.y,userDisplayOutputLinkWeights.x,0)];
            if (userDisplayOutputLinkWeights.x>=0)
            {
                for (int y2=0;y2<numNodesY;y2++)
                {
                    for (int x2=0;x2<numNodesX;x2++)
                    {
                        string toNodeName = nameLookup[Node(y2,x2,1)];
                        double weight =
                            substrate.getLink(
                                fromNodeName,
                                toNodeName
...
#ifndef HCUBE_NOGUI
    bool FindClusterExperiment::handleMousePress(wxMouseEvent& event,wxSize &bitmapSize)
    {
            ...
            )
            {
...

                {
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Lowres_LinkWeights1.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Lowres_LinkWeights2.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Lowres_Output.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Midres_Input.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Midres_LinkWeights1.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Midres_LinkWeights2.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Midres_Output.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Highres_Input.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Highres_LinkWeights1.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Highres_LinkWeights2.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
...

                    {
                        ...
                        tmpBitmap.SaveFile(
                            STRING_TO_WXSTRING(directoryString+string("Highres_Output.png")),
                            wxBITMAP_TYPE_PNG
                        );
                    }
