...
namespace HCUBE
{
    ...
    TicTacToeGameNoGeomExperiment::TicTacToeGameNoGeomExperiment(string _experimentName)
            :
    ...
    {
        shared_ptr<TicTacToeStats> ticTacToeStats = 
			static_pointer_cast<TicTacToeStats>(generation->getUserData());
