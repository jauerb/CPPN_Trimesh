...
namespace NEAT
{
    ...
    protected:
        ...
        vector<shared_ptr<GeneticIndividual> > nonDominatedIndividuals;
    ...
    public:
        ...
        inline void addNonDominated(shared_ptr<GeneticIndividual> i)
        {
            nonDominatedIndividuals.push_back(i);
        }

        inline void setIDs()
        {
            for(int i=0; i<individuals.size(); i++) {
                individuals[i]->setID(i);
            }
        }
        ...
        NEAT_DLL_EXPORT virtual void dumpReproduced(TiXmlElement *generationElement,bool includeGenes=true);
