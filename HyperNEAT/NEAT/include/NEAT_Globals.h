...
enum ActivationFunction
{
    ...
    //ACTIVATION_FUNCTION_HEAVY,
    //ACTIVATION_FUNCTION_MOD,
...
namespace NEAT
{
    ...
    protected:
        ...
        int nodeCounter,linkCounter,speciesCounter,paramCounter;
    ...
    public:
        ...
        NEAT_DLL_EXPORT void assignParamID(GeneticParamGene *testParam);
		...
		NEAT_DLL_EXPORT double getParameterValue(const char *cname, double defaultValue);

        NEAT_DLL_EXPORT double getParameterValue(string name, double defaultValue);
