...
namespace NEAT
{
    ...
    void FastNetwork<Type>::update(int iterations)
    {
       // cout << "in update\n";
        ...
        if (!this->activated)
        {
            ...
            count += int(Globals::getSingleton()->getExtraActivationUpdates());
            this->activated=true;
        }
        else
        {
    ...
    Type FastNetwork<Type>::runActivationFunction(Type tmpVal,ActivationFunction function)
    {
        ...
        /*case ACTIVATION_FUNCTION_SIGN:
            ...
            break;
        case ACTIVATION_FUNCTION_HEAVY:
#if DEBUG_ACTIVATION_CALCULATION
                cout << " <Heavy Side> ";
#endif
             if (tmpVal<0.0)
            ...
            break;
        case ACTIVATION_FUNCTION_MOD:
#if DEBUG_ACTIVATION_CALCULATION
                cout << " <Mod> ";
#endif
             retVal = (Type) ((tmpVal/2.0 ) - ((int) (tmpVal/2.0)));
