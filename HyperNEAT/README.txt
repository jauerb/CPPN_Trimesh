...
EXECUTABLE
----------
The executable "Hypercube_NEAT" is located in the "out directory."
The source files can also be compiled to create a working version in Linux,
as explained below.
...
Now, just run "make" on the directories and the dlls & libraries should be created in the out/ folder
